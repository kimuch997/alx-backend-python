# Generated by Django 4.2.7 on 2024-01-01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting an account.', verbose_name='is active')),
            ...
            options={
                'indexes': [models.Index(fields=['email'], name='chats_user_email_5b6f6d_idx')],
            },
            managers=[
